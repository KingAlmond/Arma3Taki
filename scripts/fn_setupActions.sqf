...
switch (playerSide) do
{
	case civilian:
	{
		...
		//strip weapons
		life_actions = life_actions + [player addAction["<t color = '#FFFF00'>Patdown</t>",life_fnc_removeWeaponActionCIV,"",0,false,false,"",'
		!isNull cursorTarget && player distance cursorTarget < 2.5 && isPlayer cursorTarget && (cursorTarget getVariable "restrained") ']];
		//strip clothes
		life_actions = life_actions + [player addAction["<t color = '#0BF20B'>Strip clothes</t>",life_fnc_scissors,"",0,false,false,"",'
		!isNull cursorTarget && player distance cursorTarget < 2.5 && isPlayer cursorTarget && (cursorTarget getVariable "restrained") ']];	
		//Throw in car
		...
		//Stop Escort
		life_actions = life_actions + [player addAction["<t color = '#FF0000'>Stop Escort</t>",life_fnc_civstopescort,"",0,false,false,"",'
		...
		//stripper
		life_actions = life_actions + [player addAction["<t color = '#FFFF00'>Dress woman clothes</t>",life_fnc_stripper,"",0,false,false,"",'
		!isNull cursorTarget && player distance cursorTarget < 3.5 && isPlayer cursorTarget && animationState cursorTarget == "Incapacitated" && !(cursorTarget getVariable["stripper",FALSE]) ']];
		//remove comms
		life_actions = life_actions + [player addAction["<t color = '#FFA500'>Destroy Comms</t>",life_fnc_removecomms,"",0,false,false,"",'
		!isNull cursorTarget && player distance cursorTarget < 2.5 && isPlayer cursorTarget && (cursorTarget getVariable "restrained") ']];
